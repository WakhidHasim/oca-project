...
const DataKegiatan23: React.FC = () => {
  ...
  const columns = ['No', 'Tanggal Potong', 'Uraian Kegiatan', 'Nama Badan Usaha', 'Penghasilan Bruto', 'Aksi'];
  const data: {
    id: number;
    col1: string;
    col2: string;
    ...
    <div className="pl-4 lg:pl-60 xl:pl-72 pt-24 xl:pt-28 w-full min-h-screen  relative">
      <div className="rounded-xl px-7">
        <div className="my-3 pl-3 pb-4">
          <h1 className='text-base md:text-lg font-semibold py-2'>Data Kegiatan 23</h1>
