...
const TambahDataPenerima: React.FC = () => {
  return (
    <div className="pl-4 lg:pl-60 xl:pl-72 pt-24 xl:pt-28 w-full min-h-screen pb-10">
      <div className="rounded-xl px-7">
        <div className="my-3 pl-3">
          <h1 className='text-base md:text-lg font-semibold pb-2'>Form Tambah Data Penerima Kegiatan PPh 21</h1>
          <ol className="list-none inline-flex text-xs md:text-sm">
            ...
            <li className="flex items-center">
              <p className="text-gray-800">Tambah Data Penerima Kegiatan PPh 21</p>
            </li>
          </ol>
        </div>
...
export default TambahDataPenerima;
