      ...
      <div className='rounded-xl px-2 md:px-7'>
        <div className=' my-3 pl-3'>
          <h1 className='text-base md:text-lg font-semibold py-2 '>
            Pajak Penghasilan (PPh) 4 Ayat 2
          </h1>
          <ol className='list-none inline-flex text-xs md:text-sm'>
            ...
            <li className='flex items-center'>
              <p className='text-gray-800'>Detail Panduan PPh 4 Ayat 2</p>
            </li>
          </ol>
        </div>
        ...
        <div className='w-full mx-auto p-2 pt-5'>
          <CardDetailInformasi
            ...
            tarifPajak={{
              title: 'Tarif Pajak',
              items: [
                'Tarif Pajak pada PPh Pasal 4 Ayat 2 adalah sesuai dengan Peraturan Pemerintah, pemotongan final menurut Objek Pajak yang dikenakan',
              ],
            }}
