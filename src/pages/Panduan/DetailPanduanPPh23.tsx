      ...
      <div className='rounded-xl px-2 md:px-7'>
        <div className='my-3 pl-3'>
          ...
          <ol className='list-none inline-flex text-xs md:text-sm'>
            ...
            <li className='flex items-center'>
              <p className='text-gray-800'>Detail Panduan PPh 23</p>
            </li>
          </ol>
        </div>
          ...
          <CardDetailInformasi
            ...
            objekPajak={{
              ...
              items: [
                ...
                'Royalti',
                'Sewa',
                'Jasa kepada Wajib Pajak dan Bentuk Usaha Tetap (BUT)',
              ],
            }}
            tarifPajak={{
              title: 'Tarif Pajak',
              items: [
                '15% dikenakan untuk penghasilan bunga, dividen,royalti, dan hadiah WP BUT',
                '2% dikenakan untuk jasa dan sewa ber-NPWP',
                '4% dikenakan untuk jasa dan sewa Non-NPWP',
              ],
            }}
