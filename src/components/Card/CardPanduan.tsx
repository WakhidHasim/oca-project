    ...
    <div className="w-full max-w-md mx-auto bg-white">
      <div className="border rounded shadow-md">
        <div className="flex items-center justify-center p-4 h-52 gap-5">   
          <img src={imageSrc} className="w-full" alt="Card Image" />
        </div>
        <div>
           <button className="flex items-center justify-between text-sm bg-orange text-white hover:bg-orange hover:opacity-75 rounded-b p-2 w-full">
