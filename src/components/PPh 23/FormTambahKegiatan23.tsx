    ...
    <div className="w-full mx-auto p-6 md:p-10 rounded bg-white h-full">
      <form className="w-full">
       ...
       <div className="mb-5 relative">
         ...
         <div className="mb-5 relative">
          <label className="inline-block font-semibold text-base mb-2">No Dokumentasi Referensi</label>
           <span className="text-red-500 p-1">*</span>
          <input
            type="text"
        ...
        <div className="mb-5 relative">
          <label className="inline-block font-semibold text-base mb-2">Upload Bukti Pendukung</label>
           <span className="text-red-500 p-1">*</span>
          <input
            type="file" 
            id="uploadBuktiBayar"
       ...
       <div className="mb-5 relative">
          <label className="inline-block font-semibold text-base mb-2">PIC (Pencaiiran Penghasilan)</label>
           <span className="text-red-500 p-1">*</span>
          <select
            id="pic"
            name="pic"
