       ...
       <div className="mb-5 relative">
        ...
        <div className="mb-5 relative">
          ...
          <p className="text-sm italic"> 
            <span className='text-red-500'>*</span>
              Isikan 16 digit angka NIK di KTP</p>
          <input
            type="text"
         ...
         <div className="mb-5 relative">
          <label className="inline-block font-semibold text-base mb-2">Foto KTP</label>
          <span className="text-red-500 p-1">*</span>
          <input
            type="file" 
        ...
        <div className="mb-5 relative">
          ...
          <p className="text-sm italic"> 
          <span className='text-red-500'>*</span>
            Apakah sesuai dengan nama KTP? klik jika sesuai</p>
          <input
            type="text"
            className="w-full p-2 mt-2 text-sm border rounded-md"
          />
         ...
         <div className="mb-5 relative">
          ...
          <span className="text-red-500 p-1">*</span>
           <p className="text-gray-600 text-sm italic"> 
           <span className='text-red-500'>*</span>
           Dapat berupa: foto identitas buku tabungan atau screenshot info rekening & nama m-banking
           </p>
          <input
            type="file" 
            className="w-full p-2 mt-2 text-sm border rounded-md"
