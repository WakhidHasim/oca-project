  ...
  return (
    <div className='w-full mx-auto p-5 rounded'>
                        ...
                        {Object.entries(item).map(([key, value], colIndex) => (
                          ...
                          >
                            <div className='text-sm leading-5 font-medium text-gray-900'>
                              {key === 'col5' ||
                              key === 'col6' ||
                              (key === 'col7' && React.isValidElement(value))
                                ? value
                                : String(value)}
                            </div>
                          </td>
      ...
      <div className='flex justify-between my-3 pt-10'>
        <p className='text-xs'>Showing 0 to 10 of 1 entries</p>
        <div>
          <ul className='flex items-center -space-x-px h-8 text-sm'>
            ...
            <li>
              <a className='flex items-center justify-center px-3 h-8 leading-tight border bg-gray-300 '>
                1
              </a>
            </li>
            <li>
